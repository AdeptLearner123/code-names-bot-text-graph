...
class SenseProposer:
    ...
    def _assign_multi_word_possibilities(self, doc, token_senses, lemma_to_senses, length):
    ...
    def propose_senses(self, text):
        ...
        for length in range(2, 5):
            self._assign_multi_word_possibilities(doc, token_senses, self._lemmas_by_length[length], length)
        self._assign_single_word_possibilities(doc, token_senses, self._lemmas_by_length[1])
